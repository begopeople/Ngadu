...
<h5 class="text-dark text-center mb-3" data-aos="fade-left">Isi laporan kamu disini</h5>
    ...
    <div class="container">
      <?php if (isset($sukses)) : ?>
        ...
        <div class="alert alert-dismissible fade show" style="background-color: #3bb849;" role="alert">
          <h5 class="text-gray-100 mt-2">Aduan atau laporan kamu sedang di proses nih, ditunggu ya!</h5>
      ...
      <div class="row">
        <div class="col-4">
          <div class="image">
            <img src="../../assets/img/investigate.jpg" width="300" alt="">
          </div>
        </div>
