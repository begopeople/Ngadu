    ...
    <div class="card-body border-bottom-primary">
      ...
      <form action="" method="post">
        <div class="form-group">
          <input type="text" class="form-control py-4 shadow-sm" placeholder="NIK" style="border-radius: 25px;" name="nik">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <input type="text" class="form-control py-4 shadow-sm" placeholder="No telepon" style="border-radius: 25px;" name="telp">
        </div>
        <div class="button">
