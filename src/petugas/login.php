        ...
        <div class="col-6">
          <form action="" method="post" class="mt-3">
            <div class="form-group text-center">
              ...
              <input type="text" class="form-control shadow" style="border: none; border-radius:20px;" id="exampleInputEmail1" placeholder="Masukkan Username Kamu" name="username">
            </div>
            <div class="form-group text-center">
              <label for="exampleInputPassword1">Password</label>
              <input type="password" class="form-control shadow" style="border: none; border-radius:20px;" id="exampleInputPassword1" placeholder="Masukkan Password Kamu" name="password">
            </div>
            <div class="mt-4 text-center">
              <button type="submit" name="submit" class="btn btn-primary shadow-lg col-6" style="border-radius:20px;">Masuk</button>
            </div>
          </form>
        </div>
        <div class="col-6">
          <div class="image">
            <img src="../../assets/img/forest-bro.svg" width="270" alt="">
          </div>
        </div>
      </div>
    </div>
